...
const categories: CashbookCategory[] = [
  ...
  { ...base, id: '6', group: 'income', subGroup: 'irregular_income', name: '인센티브', icon: 'trophy', color: '#D8A05E', sortOrder: 1 },
  { ...base, id: '7', group: 'flex', subGroup: 'joint_flex', name: '여행', icon: 'airplane', color: '#F0A05E', sortOrder: 0 },
  { ...base, id: '8', group: 'flex', subGroup: 'personal_flex', name: '소비', icon: 'shopping_bag', color: '#A0F05E', sortOrder: 1 },
];
