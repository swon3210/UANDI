...
재테크 공간의 홈. 사용자가 재테크 BottomNav의 "홈" 탭으로 진입했을 때 처음 보는 화면이다.
...
- 진입점: AppShell 재테크 모드의 BottomNav "홈" 탭
- 재테크 BottomNav: 홈(/outer) · 환테크(/outer/forex) · 투자(/outer/investment) · 적금(/outer/savings)
...
```
┌───────────────────────────────┐
│ [💼 재테크 ▾]      ⚙️  [👤]    │  ← AppShell 상단 (SpaceSwitcher)
├───────────────────────────────┤
│                               │
│  안녕하세요, 진송 👋          │
│                               │
